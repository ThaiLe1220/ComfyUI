...
| `ltx-2.3-22b-dev_embeddings_connectors.safetensors` | 2.31 GB | `models/text_encoders/` |
| `ltx-2.3-22b-dev_video_vae.safetensors` | 1.45 GB | `models/vae/` |
| `ltx-2.3-22b-distilled-lora-384.safetensors` | 7.61 GB | `models/loras/` |

Requires `ComfyUI-GGUF` custom node. Use `UnetLoaderGGUF` node instead of `CheckpointLoaderSimple`.
