...
if __name__ == "__main__":
    data_file_path = (
        "/home/ubuntu/Desktop/eugene/ComfyUI/input/pexels_v2_metadata_final.txt"
    )
    output_dir = "/home/ubuntu/Desktop/eugene/ComfyUI/output"
    video_prompts = read_data_file(data_file_path)

    # Use list slicing to get the first 800 items
    limited_prompts = video_prompts[:1400]
    ...
    for index, (video_id, positive_prompt) in enumerate(limited_prompts):
        ...
        video_path = f"/home/ubuntu/Desktop/eugene/ComfyUI/input/pexels/{video_id}"
        print(
